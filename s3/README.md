...
| Triple click (three clicks < 400 ms apart)     | Cycle through `MOTION_VELOCITY_PRESETS` (20 / 31 / 43 rad/s). LEDs flash the new preset's index + 1 times as feedback. Persisted to NVS. |
