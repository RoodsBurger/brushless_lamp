...
: FOCMotor()
{
  ...
  // PATCH: backported from Arduino-FOC 2.4.0 — the `_KV*_SQRT2` in 2.3.0 was a bug
  // that over-multiplied KV by √2, causing voltage_bemf to be underestimated in
  // voltage-torque mode and producing ~1.4× less torque than the motor is capable of.
  KV_rating = _KV;
